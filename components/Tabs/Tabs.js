...
class TabLink {
  ...
  select() {
    ...
    TweenMax.to(this.element, .25, { className: "+=tabs-link-selected" });
...
class TabItem {
  ...
  select() {
    ...
    TweenMax.to(this.element, .25, { className: "+=tabs-item-selected" });
    TweenMax.to(this.element, 2.5, { opacity: 1 });
  }
}
